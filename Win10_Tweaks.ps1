...
Function DisableRecentlyAdded {
	Write-Output "Disabling Showing Recently Added Apps..."
	Set-ItemProperty -Path "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer" -Name "ShowRecent" -Type DWord -Value 0
}

# Disable Shortcut on Shortcuts
Function DisableShortcutOnShortcuts {
	Write-Output "Disabling '-Shortcut' on Shortcuts"
	New-Item -Path "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer" -Name NamingTemplates -Force | Out-Null
	New-ItemProperty -Path "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\NamingTemplates" -Name "ShortcutNameTemplate" -PropertyType "String" -Value '%s.lnk' | Out-Null
}
...
Function UninstallMsftBloat {
	...
	Get-AppxPackage "Microsoft.MinecraftUWP" | Remove-AppxPackage | Out-Null
...
function UninstallThirdPartyBloat {
	...
	Get-AppxPackage "E046963F.LenovoCompanion" | Remove-AppxPackage | Out-Null
	...
	Get-AppxPackage "LenovoCorporation.LenovoID" | Remove-AppxPackage | Out-Null
	Get-AppxPackage "LenovoCorporation.LenovoSettings" | Remove-AppxPackage | Out-Null
...
Function UninstallWindowsStore {
	...
	Get-AppxPackage "Microsoft.DesktopAppInstaller" | Remove-AppxPackage | Out-Null
