...
$applications = ("VisualStudioCode","VMwareWorkstation","Office365ProPlus")
$hosts = "C:\Windows\System32\Drivers\etc\hosts"
$internet = ("GoogleChrome","VMware-Horizon-Client","Deluge","AmazonDrive","nordvpn","openssh","vnc-viewer")
$multimedia = ("FFmpeg","MediaInfo","Amazon-Music","XnViewMP")
$other = ("Choco-Upgrade-All-At-Startup","Chocolatey-AutoUpdater","Powershell-Core","VSCode-Powershell","rsat","LogitechGaming")
...
$utilities = ("clink","WinRAR","NotepadPlusPlus","CCleaner","DropBox","Rufus")
$webclient = New-Object System.Net.WebClient 
$choco_installs = $applications + $internet + $multimedia + $utilities + $other
...
Write-Host "Creating HKCU for Powershell"
